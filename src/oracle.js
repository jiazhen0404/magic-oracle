...
const BUILD = '0831-81f2b9';   /* 版本標記，三個頁面下方都會顯示 */
const PRICE = 399;
...
「半年內我適不適合換工作」，背景說「產業前景不好，但還不知道想轉什麼方向」
→ 這是兩題：要不要離開現在這份，跟下一步往哪走。
　 問：「這裡有兩件事：要不要離開現在這份，還有下一步往哪走。
　　　　老師這次只回答一件，你想先問哪一個？」
...
## 同一件事裡藏著兩個問題
比「同時問感情跟工作」更常見，也更容易漏掉。
使用者寫的是一句話，但問題本身或背景透露出他其實想問兩件事。
老師只會回答一件，一定要請他選。

**最常見的三組**

「該不該離開」與「該往哪去」
　「半年內我適不適合換工作」＋背景說「還不知道想轉什麼方向」
　→ 要不要走，跟往哪走，是兩件事。
　　 問：「這裡有兩件事：要不要離開現在這份，還有下一步往哪走。
　　 　　 老師這次只回答一件，你想先問哪一個？」

「會不會發生」與「該不該做」
　「我們會不會復合」＋背景說「我也在想要不要放下」
　→ 會不會，跟你該怎麼選，是兩件事。

「對方怎麼想」與「我該怎麼做」
　「他到底怎麼想我」＋背景說「我不知道還要不要等」
　→ 他的想法，跟你的行動，是兩件事。

**怎麼判斷**
把問題句和背景放在一起看。
若要回答得完整需要用到兩套不同的推論，那就是兩題。
「他會不會回來」只要看對方；「我該不該等」要看使用者自己。這是兩套。

**問法**
把兩個選項具體講出來，不要問「你想問哪一個」就沒了。
　差：「你想問哪一件事？」
　好：「這裡有兩件事：要不要離開現在這份，還有下一步往哪走。你想先問哪一個？」

未被選中的那一個放進 extra。

若使用者說「都想知道」或「兩個一起」，回覆：
「老師這次只會回答一件，另一件我先記著。你想先問哪一個？」
不可以幫他合併成一個問題。
